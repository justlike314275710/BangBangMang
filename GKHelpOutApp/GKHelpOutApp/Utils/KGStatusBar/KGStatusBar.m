...
+ (void)showWithStatus:(NSString*)status {
    [[KGStatusBar sharedView] showWithStatus:status barColor:[UIColor colorWithRed:255.0/255.0 green:181.0/255.0 blue:197.0/255.0 alpha:1.0] textColor:[UIColor blackColor]];
}

+ (void)showErrorWithStatus:(NSString*)status {
    [[KGStatusBar sharedView] showWithStatus:status barColor:[UIColor colorWithRed:255.0/255.0 green:181.0/255.0 blue:197.0/255.0 alpha:1.0] textColor:[UIColor grayColor]];
    //[KGStatusBar performSelector:@selector(dismiss) withObject:self afterDelay:2.0 ];
}
