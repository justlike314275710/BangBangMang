...
- (void)refresh:(NIMMessageModel*)data{
    ...
    self.subTitleLabel.text=attachment.time;
...
- (UIImage *)chatBubbleImageForState:(UIControlState)state outgoing:(BOOL)outgoing{
    ...
    self.titleLabel.frame = CGRectMake(58, 10, 150, 20);
    self.subTitleLabel.frame=CGRectMake(58, 30, 150, 13);
